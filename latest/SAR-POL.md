...
#### <!-- edit:/home/runner/work/ceos-ard/ceos-ard/requirements/measurements/backscatter-pol.yaml-->`5.1.` Backscatter Measurements (POL) {#sec:rcm.measurements-backscatter-pol label="|Radiometrically Corrected Measurements: Backscatter Measurements (POL)"}
